...
const ChatTitle = React.memo(() => {
  ...
  return config ? (
    <>
      <div 
        className='fixed z-index-1000 flex gap-x-4 gap-y-1 flex-wrap justify-center border border-black/10  p-3 dark:border-gray-900/50 text-gray-600 dark:text-gray-300 cursor-pointer'
        onClick={() => {
          setIsModalOpen(true);
        }}
      >
